...
public class FileScanNode extends SelectNode {
    ...
    public void prepare() {
        ...
        cost = new PlanCost(tableStats.numTuples *
                SelectivityEstimator.estimateSelectivity(predicate, schema, fileStats),
                tableStats.avgTupleSize, tableStats.numTuples, tableStats.numDataPages);
